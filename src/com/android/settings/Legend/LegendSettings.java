package com.android.settings.Legend;
...
public class LegendSettings extends SettingsPreferenceFragment {
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        menu.add(0, MENU_HELP, 0, R.string.Legendtweaks_dialog_title)
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case MENU_HELP:
                ...
                (R.string.Legendtweaks_dialog_toast),
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            switch (id) {
                case MENU_HELP:
                    ...
                    .setTitle(R.string.Legendtweaks_dialog_title)
                    .setMessage(R.string.Legendtweaks_dialog_message)
                    .setCancelable(false)
